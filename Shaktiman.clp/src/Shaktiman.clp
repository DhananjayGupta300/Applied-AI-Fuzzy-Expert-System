...
;---------------------------------------------
; RULE 1:  EXPERT SYSTEM WELCOMES YOU
;---------------------------------------------
...
;-----------------------------------------------------------
; RULE 2:  PRINT THE USER's INPUT(asserted by the grader)
;-----------------------------------------------------------    
 (defrule initial
    (declare (salience 99))
    ?Business_loan_applicant <- (Business_loan_applicant (applicant_name ?applicant_name))
...
(assert (Business_loan_applicant (applicant_name "Shaktiman 1")
            (age 18) (current_owe 20000) (paid Yes)
            (exp 12.0)  (bus 10)  (edu 2)  (inv 90000)
            (repay Good)  (mgmt Good)  (credit Good)))
(run)                  